...
struct cmd_spec cmd_table[] = {
    ...
    { "mcd",
      ...
      "List mcd status",
      "[<Domain>|-a] [-d]",
      " -a                              All domains displayed\n"
      " -d                              Detailed information",
    },
    { "mcd-size",
      &main_mcd_memsize,
      "Set mcd maximum memory size in MB",
      //"[<Domain>|-a] [-m[=MEMSIZE_GB]]",
      "[-m[=MEMSIZE_MB]]",
      " -m MEMSIZE                      Memory Size in MB",
    },
    { "mcd-weight",
      &main_mcd_weight,
      "Set dom weight",
      "[-d[=DOMAIN]] [-w[=WEIGHT]]",
      " -d DOMAIN                       Domain Id"
      " -w WEIGHT                       Domain Weight",
    },
    { "mcd-cache-mode",
      &main_mcd_cache_mode,
      "Set cache mode",
      "[[-r[=REPLACEMENT MODE]] -r[=PARTITION_MODE]]",
      //" -c CACHE MODE                   0 = shared, 1 = partition\n"
      " -r REPLACEMENT MODE             0 = LFRU, 1 = FAST, 2 = SCORE\n"
      " -p PARTITION MODE               0 = BEST-EFFORT, 1 = WEIGHT-BASED, 2 = ADAPTIVE-DYNAMIC",
    },
    { "mcd-param",
      &main_mcd_param,
      "Set SSD Param",
      "[[-z[=DISPLAY] -a[MEM ALPHA] -b[MEM BETA] -c[SSD ALPHA] -d[SSD BETA]]]",
      " -z DISPLAY PARAMS \n"
      " -a MEMORY ALPHA [0, 100] \n"
      " -b MEMORY BETA [0, 100] \n"
      " -c SSD ALPHA [0, 100] \n"
      " -d SSD BET [0, 100] A",
    },
